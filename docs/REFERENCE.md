...
report/         build_report.py + README.md  reviewer report: schematic vs
                figs/ data/ layout/ schematic/ v1/v2/v3 layouts, every bench,
...
(`layout/codesign/`, `notebooks/04`) that produced the v3 layout of record
(post-layout S11 −10.05 / S22 −10.72 dB, 6880 µm²). The `bias`-port VCCS
