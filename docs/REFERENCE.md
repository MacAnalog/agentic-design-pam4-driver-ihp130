...
report/         build_report.py + README.md  reviewer report: schematic vs
                figs/ data/ layout/ schematic/ v1/v2/v3/v4 layouts, every bench,
...
(`layout/codesign/`, `notebooks/04`) that produced the v4 layout of record
(post-layout S11 −10.03 / S22 −10.71 dB at the block's halo-8 instrument,
−10.07 / −10.81 at halo 20, 7055 µm²). The `bias`-port VCCS
